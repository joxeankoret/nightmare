...
from cmiller_mutator import main as cmiller_mutate

#-----------------------------------------------------------------------
class CMultipleCMillerMutator:
...
def main(path, number, output):
  mutator = CMultipleCMillerMutator(path, int(number), output)
  mutator.mutate()
